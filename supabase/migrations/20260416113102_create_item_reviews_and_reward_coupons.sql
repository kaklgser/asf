/*
  ...
  1. New Tables
    ...
    - `review_reward_coupons`
      - `id` (uuid, primary key)
      - `user_id` (uuid, references auth.users)
      - `item_review_id` (uuid, references item_reviews)
      - `code` (text, unique)
  ...
  2. Orders Updates
    - Adds `review_reward_coupon_id` column
    - Adds `review_reward_discount_amount` column

  3. Security
    - Enable RLS on both new tables
    - Users and staff can view item reviews
    - Users can view their own review reward coupons
*/
